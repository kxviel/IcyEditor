...
function RouteComponent() {
  ...
  return (
    <div className="w-full">
      <div className="mx-auto flex h-[calc(100vh-72px)] max-w-7xl flex-col items-center justify-center gap-6">
          ...
          >
            <div className="flex h-[274px] flex-col gap-6 px-4 py-5">
              ...
              <ul className="list-disc space-y-2 pl-4 text-sm opacity-60">
                <li>
                  Select questions manually from multiple or a single book.
                </li>
          ...
          >
            <div className="flex h-[274px] flex-col gap-6 px-4 py-5">
              ...
              <ul className="list-disc space-y-2 pl-4 text-sm opacity-60">
                ...
                <li>
                  No need to pick individual questions—let the system do the
                  work.
                </li>
              </ul>
            </div>
